...
import { generalSplitClick, generalHandleMouseUp, generateSplits } from './utils/annotation-utils';
...
const TextAnnotator = <T extends AnnotateTag>({
  ...
  const decoratedHandleSplitClick = () => {
    return (split: Span) => generalSplitClick(split, value, isBlendable, onChange);
  };
